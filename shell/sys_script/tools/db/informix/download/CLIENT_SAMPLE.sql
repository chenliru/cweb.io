CONNECT TO 'DATABASE' USER 'lchen' USING 'admin12';

unload to /home/lchen/tools/db/informix/download/YEARMONTH.tmp delimiter '^'
select
x0.acctsecurno,
x0.transno,
x0.b3type,
...
where ( x0.liiclientno in ( CLINETNO ) ) and
      ( x0.approveddate like 'YEAR/MONTH/%' ) and
