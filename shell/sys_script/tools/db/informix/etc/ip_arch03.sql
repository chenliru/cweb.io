...
{ TABLE "informix".securuser row size = 181 number of columns = 11 index size = 43 
              }
...
{ TABLE "informix".b3b row size = 45 number of columns = 5 index size = 18 }
...
{ TABLE "informix".tariff row size = 514 number of columns = 41 index size = 161 
              }
create table "informix".tariff 
  (
    ...
    specialinstruct char(16) not null ,
...
{ TABLE "informix".rpt_b3 row size = 414 number of columns = 44 index size = 22 }
...
{ TABLE "informix".rpt_b3_line row size = 513 number of columns = 76 index size = 
              35 }
...
{ TABLE "informix".b3 row size = 561 number of columns = 47 index size = 106 }
create table "informix".b3 
  (
    ...
    sbrnno char(15) not null ,
    ccnqty integer not null ,
    ccinumlines integer not null ,
    invoiceqty integer not null ,
    warehousenum integer not null ,
    entname char(35) not null ,
    entaddr1 char(35) not null ,
    entaddr2 char(35) not null ,
    entaddr3 char(35) not null ,
    entaddr4 char(30) not null ,
    entpostcd char(9) not null ,
    primary key (b3iid) 
  ) extent size 32 next size 32 lock mode row;
...
{ TABLE "informix".b3_line row size = 429 number of columns = 41 index size = 18 
              }
create table "informix".b3_line 
  (
    ...
    gstexemptcode char(3) not null ,
    exctaxexmptcode char(2) not null ,
    rulingnumber char(45) not null ,
    trqno integer not null ,
    prevtransno char(14) not null ,
    prevlineno integer not null ,
...
create table "informix".b3_recap_details 
  (
    ...
    percentsplit float not null ,
    detailponumber char(15) not null ,
    unitprice float not null ,
...
{ TABLE "informix".b3_line_dia row size = 31 number of columns = 4 index size = 0 
              }
create table "informix".b3_line_dia 
  (
    informix_tupleid integer,
    objtype char(1),
    objowner char(8),
    objname char(18)
  ) extent size 32 next size 32 lock mode page;

revoke all on "informix".b3_line_dia from "public" as "informix";

{ TABLE "informix".b3_line_vio row size = 375 number of columns = 40 index size = 
              0 }
create table "informix".b3_line_vio 
  (
    b3lineiid integer,
    b3subiid integer,
    b3lineno integer,
    ...
    totalduty float,
    gstexemptcode char(3),
    exctaxexmptcode char(2),
    informix_tupleid serial not null ,
    informix_optype char(1),
    informix_recowner char(8)
  ) extent size 32 next size 32 lock mode page;

revoke all on "informix".b3_line_vio from "public" as "informix";

{ TABLE "informix".loaddia_29 row size = 31 number of columns = 4 index size = 0 
              }
create table "informix".loaddia_29 
  (
    informix_tupleid integer,
    objtype char(1),
    objowner char(8),
    objname char(18)
  ) in datadbs2  extent size 32 next size 32 lock mode page;

revoke all on "informix".loaddia_29 from "public" as "informix";

{ TABLE "informix".loadvio_29 row size = 73 number of columns = 11 index size = 0 
              }
create table "informix".loadvio_29 
  (
    b3recapiid integer,
    b3lineiid integer,
    ccipageno integer,
...
revoke all on "informix".loadvio_29 from "public" as "informix";

{ TABLE "informix".loaddia_16 row size = 31 number of columns = 4 index size = 0 
              }
create table "informix".loaddia_16 
  (
    informix_tupleid integer,
    objtype char(1),
    objowner char(8),
...
revoke all on "informix".loaddia_16 from "public" as "informix";

{ TABLE "informix".loadvio_16 row size = 137 number of columns = 7 index size = 0 
              }
create table "informix".loadvio_16 
  (
    b3linecommentiid integer,
    b3lineiid integer,
    comment1 char(58),
    comment2 char(58),
    informix_tupleid serial not null ,
...
revoke all on "informix".loadvio_16 from "public" as "informix";

{ TABLE "informix".status_history_dia row size = 31 number of columns = 4 index size 
              = 0 }
create table "informix".status_history_dia 
  (
    informix_tupleid integer,
    objtype char(1),
    objowner char(8),
...
revoke all on "informix".status_history_dia from "public" as "informix";

{ TABLE "informix".status_history_vio row size = 41 number of columns = 6 index size 
              = 0 }
create table "informix".status_history_vio 
  (
    b3iid integer,
    status integer,
    statusdate char(20),
...
revoke all on "informix".status_history_vio from "public" as "informix";

{ TABLE "informix".tariff_dia row size = 31 number of columns = 4 index size = 0 
              }
create table "informix".tariff_dia 
  (
    informix_tupleid integer,
    objtype char(1),
    objowner char(8),
...
revoke all on "informix".tariff_dia from "public" as "informix";

{ TABLE "informix".tariff_vio row size = 527 number of columns = 44 index size = 
              0 }
create table "informix".tariff_vio 
  (
    liiclientno integer,
    vendorname char(25),
    productkeyword char(25),
    productsufx integer,
    approvalcode char(1),
    b3description char(58),
    b3refbrch integer,
    b3refno integer,
    createdate char(20),
    cooindicator char(1),
    cooexprydate char(20),
    exctaxlicind char(1),
    gstexemptcode char(3),
    gstratecode char(1),
    hsno char(10),
    ...
    moduser char(12),
    oic char(16),
    oicexprydate char(20),
    percentsplit float,
    placeexp char(4),
    remissno char(16),
    remissexprydate char(20),
    rulingno char(45),
    rulingexprydate char(20),
    specialinstruct char(16),
    remarks char(58),
    tariffcode char(4),
    tarifftrtmnt char(2),
    vfdcode char(3),
...
revoke all on "informix".tariff_vio from "public" as "informix";

{ TABLE "ipgown".t1130 row size = 206 number of columns = 10 index size = 0 }
create table "ipgown".t1130 
  (
    acctsecurno integer not null ,
    transno integer not null ,
    purchaseorder1 char(15) not null ,
    vendorname char(35) not null ,
    statemodeldesc char(50) not null ,
    reldate char(20) not null ,
    description char(35) not null ,
    cargcntrlno char(35) not null ,
    liibrchno integer not null ,
    liirefno integer not null 
  ) extent size 32 next size 32 lock mode page;

revoke all on "ipgown".t1130 from "public" as "ipgown";

{ TABLE "ipgown".t1132 row size = 100 number of columns = 10 index size = 0 }
create table "ipgown".t1132 
  (
    acctsecurno integer not null ,
    transno integer not null ,
    approveddate char(20) not null ,
...
revoke all on "ipgown".t1132 from "public" as "ipgown";

{ TABLE "ipgown".t1134 row size = 150 number of columns = 7 index size = 0 }
create table "ipgown".t1134 
  (
    claimrefno char(14) not null ,
    claimvendorname char(35) not null ,
    b3acctsecurno integer not null ,
...
revoke all on "ipgown".t1134 from "public" as "ipgown";

{ TABLE "ipgown".t1136 row size = 207 number of columns = 13 index size = 0 }
create table "ipgown".t1136 
  (
    liiclientno integer not null ,
    productkeyword char(25) not null ,
    productsufx integer not null ,
    ...
    hsno char(10) not null ,
    tariffcode char(4) not null ,
    tarifftrtmntcode char(2) not null ,
    tarifftrtmnt char(35) not null ,
    lastuseddate char(20) not null ,
    cooindicator char(1) not null ,
    oic char(16) not null ,
    remissno char(16) not null ,
...
revoke all on "ipgown".t1136 from "public" as "ipgown";

{ TABLE "ipgown".t1138 row size = 164 number of columns = 12 index size = 0 }
create table "ipgown".t1138 
  (
    liiclientno integer not null ,
    liiaccountno integer not null ,
    itemdate char(20) not null ,
...
revoke all on "ipgown".t1138 from "public" as "ipgown";

{ TABLE "informix".tmp_tarifftrtmnt row size = 38 number of columns = 2 index size 
              = 0 }
...
revoke all on "informix".tmp_tarifftrtmnt from "public" as "informix";
...
grant select on "informix".b3_line_dia to "public" as "informix";
grant update on "informix".b3_line_dia to "public" as "informix";
grant insert on "informix".b3_line_dia to "public" as "informix";
grant delete on "informix".b3_line_dia to "public" as "informix";
grant index on "informix".b3_line_dia to "public" as "informix";
grant select on "informix".b3_line_vio to "public" as "informix";
grant update on "informix".b3_line_vio to "public" as "informix";
grant insert on "informix".b3_line_vio to "public" as "informix";
grant delete on "informix".b3_line_vio to "public" as "informix";
grant index on "informix".b3_line_vio to "public" as "informix";
grant select on "informix".loaddia_29 to "public" as "informix";
grant update on "informix".loaddia_29 to "public" as "informix";
grant insert on "informix".loaddia_29 to "public" as "informix";
grant delete on "informix".loaddia_29 to "public" as "informix";
grant index on "informix".loaddia_29 to "public" as "informix";
grant select on "informix".loadvio_29 to "public" as "informix";
grant update on "informix".loadvio_29 to "public" as "informix";
grant insert on "informix".loadvio_29 to "public" as "informix";
grant delete on "informix".loadvio_29 to "public" as "informix";
grant index on "informix".loadvio_29 to "public" as "informix";
grant select on "informix".loaddia_16 to "public" as "informix";
grant update on "informix".loaddia_16 to "public" as "informix";
grant insert on "informix".loaddia_16 to "public" as "informix";
grant delete on "informix".loaddia_16 to "public" as "informix";
grant index on "informix".loaddia_16 to "public" as "informix";
grant select on "informix".loadvio_16 to "public" as "informix";
grant update on "informix".loadvio_16 to "public" as "informix";
grant insert on "informix".loadvio_16 to "public" as "informix";
grant delete on "informix".loadvio_16 to "public" as "informix";
grant index on "informix".loadvio_16 to "public" as "informix";
grant select on "informix".status_history_dia to "public" as "informix";
grant update on "informix".status_history_dia to "public" as "informix";
grant insert on "informix".status_history_dia to "public" as "informix";
grant delete on "informix".status_history_dia to "public" as "informix";
grant index on "informix".status_history_dia to "public" as "informix";
grant select on "informix".status_history_vio to "public" as "informix";
grant update on "informix".status_history_vio to "public" as "informix";
grant insert on "informix".status_history_vio to "public" as "informix";
grant delete on "informix".status_history_vio to "public" as "informix";
grant index on "informix".status_history_vio to "public" as "informix";
grant select on "informix".tariff_dia to "public" as "informix";
grant update on "informix".tariff_dia to "public" as "informix";
grant insert on "informix".tariff_dia to "public" as "informix";
grant delete on "informix".tariff_dia to "public" as "informix";
grant index on "informix".tariff_dia to "public" as "informix";
grant select on "informix".tariff_vio to "public" as "informix";
grant update on "informix".tariff_vio to "public" as "informix";
grant insert on "informix".tariff_vio to "public" as "informix";
grant delete on "informix".tariff_vio to "public" as "informix";
grant index on "informix".tariff_vio to "public" as "informix";
grant select on "ipgown".t1130 to "public" as "ipgown";
grant update on "ipgown".t1130 to "public" as "ipgown";
grant insert on "ipgown".t1130 to "public" as "ipgown";
grant delete on "ipgown".t1130 to "public" as "ipgown";
grant index on "ipgown".t1130 to "public" as "ipgown";
grant select on "ipgown".t1132 to "public" as "ipgown";
grant update on "ipgown".t1132 to "public" as "ipgown";
grant insert on "ipgown".t1132 to "public" as "ipgown";
grant delete on "ipgown".t1132 to "public" as "ipgown";
grant index on "ipgown".t1132 to "public" as "ipgown";
grant select on "ipgown".t1134 to "public" as "ipgown";
grant update on "ipgown".t1134 to "public" as "ipgown";
grant insert on "ipgown".t1134 to "public" as "ipgown";
grant delete on "ipgown".t1134 to "public" as "ipgown";
grant index on "ipgown".t1134 to "public" as "ipgown";
grant select on "ipgown".t1136 to "public" as "ipgown";
grant update on "ipgown".t1136 to "public" as "ipgown";
grant insert on "ipgown".t1136 to "public" as "ipgown";
grant delete on "ipgown".t1136 to "public" as "ipgown";
grant index on "ipgown".t1136 to "public" as "ipgown";
grant select on "ipgown".t1138 to "public" as "ipgown";
grant update on "ipgown".t1138 to "public" as "ipgown";
grant insert on "ipgown".t1138 to "public" as "ipgown";
grant delete on "ipgown".t1138 to "public" as "ipgown";
grant index on "ipgown".t1138 to "public" as "ipgown";
grant select on "informix".tmp_tarifftrtmnt to "public" as "informix";
grant update on "informix".tmp_tarifftrtmnt to "public" as "informix";
grant insert on "informix".tmp_tarifftrtmnt to "public" as "informix";
grant delete on "informix".tmp_tarifftrtmnt to "public" as "informix";
grant index on "informix".tmp_tarifftrtmnt to "public" as "informix";
...
CREATE PROCEDURE "informix".archiveandpurge01() RETURNING INT, CHAR(20);
  ...
  EXECUTE PROCEDURE insertArch01(startdate, enddate);
...
--   FOREACH 
--     EXECUTE PROCEDURE deleteB3(startdate, enddate) INTO s_b3iid, s_approveddate
...
CREATE PROCEDURE "informix".cleanb3(startdate CHAR(20), enddate CHAR(20))
  ...
  FOREACH
     ...
     FROM b3
     WHERE
       (approveddate >= startdate and approveddate <= enddate)
...
CREATE PROCEDURE "informix".insertarch01(startdate CHAR(20),enddate CHAR(20))
...
grant  execute on function "informix".archiveandpurge01 () to "public" as "informix";
...
grant  execute on procedure "informix".insertb3 (integer) to "public" as "informix";
grant  execute on procedure "informix".insertb3subheader (integer) to "public" as "informix";
grant  execute on procedure "informix".insertb3line (integer) to "public" as "informix";
grant  execute on procedure "informix".insertarch (char,char) to "public" as "informix";
grant  execute on procedure "informix".insertarch01 (char,char) to "public" as "informix";
grant  execute on function "informix".cleanb3 (char,char) to "public" as "informix";
...
create view "ipgown".vw_as_accounted (asacctiid,claimlogiid,b3description) as 
...
create view "ipgown".trk_srb3_4 (data,b3iid,liibrchno,liirefno) as 
  select ((((((((((((((((((((((((((((((((((((((((((((((((((((((((
    'B3ENTRY1' || x0.acctsecurno ) || x5.ch [1,1] ) || x0.transno 
    ) || x5.ch [1,1] ) || x0.b3type ) || x5.ch [1,1] ) || x0.purchaseorder1 
    ) || x5.ch [1,1] ) || x0.purchaseorder2 ) || x5.ch [1,1] 
    ) || x0.vendorname ) || x5.ch [1,1] ) || x0.vendorstate ) 
    || x5.ch [1,1] ) || x0.vendorzip ) || x5.ch [1,1] ) || x1.description 
    ) || x5.ch [1,1] ) || x0.cargcntrlno ) || x5.ch [1,1] ) || 
    round(x0.freight , 2 ) ) || x5.ch [1,1] ) || x3.description 
    ) || x5.ch [1,1] ) || round(x0.weight , 2 ) ) || x5.ch [1,
    1] ) || round(x0.cargcntrlqty , 2 ) ) || x5.ch [1,1] ) || 
    x0.locationofgoods ) || x5.ch [1,1] ) || x4.description ) 
    || x5.ch [1,1] ) || x0.shipvia ) || x5.ch [1,1] ) || x0.containerno 
    ) || x5.ch [1,1] ) || x0.billoflading ) || x5.ch [1,1] ) 
    || x2.description ) || x5.ch [1,1] ) || round(x0.totb3vfd 
    , 2 ) ) || x5.ch [1,1] ) || round(x0.totb3duty , 2 ) ) || 
    x5.ch [1,1] ) || round(x0.totb3sima , 2 ) ) || x5.ch [1,1] 
    ) || round(x0.totb3exctax , 2 ) ) || x5.ch [1,1] ) || round(x0.totb3gst 
    , 2 ) ) || x5.ch [1,1] ) || x0.approveddate [1,10] ) || x5.ch 
    [1,1] ) || x0.reldate [1,10] ) || x5.ch [1,1] ) || p_invbrchno(x0.liibrchno 
    )) || p_invrefno(x0.liirefno )) ,x0.b3iid ,x0.liibrchno ,
...
create view "ipgown".trk_srb3line (data,b3lineiid,b3subiid) as 
  select (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((
    ...
    [1,1] ) || x0.linecomment ) || x1.ch [1,1] ) ,x0.b3lineiid 
    ,x0.b3subiid from "informix".b3_line x0 ,"ipgown".delimiter 
    x1 ;                                                     
          
create view "ipgown".trk_srb3recap (data,b3lineiid) as 
  select (((((((((((('B3ENTRY4' || x0.ccipageno ) || x1.ch [1,1] 
    ) || x0.ccilineno ) || x1.ch [1,1] ) || x0.uom ) || x1.ch 
    [1,1] ) || round(x0.quantity , 2 ) ) || x1.ch [1,1] ) || 
    round(x0.amount , 2 ) ) || x1.ch [1,1] ) || x0.proddesc ) 
    || x1.ch [1,1] ) ,x0.b3lineiid from "informix".b3_recap_details 
...
create view "ipgown".trk_tariff (liiclientno,vendorname,productkeyword,productsufx,data1,data2,data3) as 
  select x0.liiclientno ,x0.vendorname ,x0.productkeyword ,x0.productsufx 
    ,(((((((((((((((((((x0.vendorname || x2.ch ) || x1.description 
    ) || x2.ch ) || x0.productkeyword ) || x2.ch ) || x0.hsno 
    ) || x2.ch ) || x0.tariffcode ) || x2.ch ) || x0.vfdcode 
    ) || x2.ch ) || x0.productsufx ) || x2.ch ) || x0.b3description 
    ) || x2.ch ) || x0.remarks ) || x2.ch ) || x0.tarifftrtmnt 
    ) || x2.ch ) ,((((((((((((((((((x2.ch || round(x0.exctaxamt 
    , 6 ) ) || x2.ch ) || round(x0.exctaxdeduct , 2 ) ) || x2.ch 
    ) || x0.exctaxdeductunit ) || x2.ch ) || round(x0.exctaxrate 
    , 2 ) ) || x2.ch ) || x0.exctaxunit ) || x2.ch ) || x0.exctaxlicind 
    ) || x2.ch ) || x0.exctaxexmptcode ) || x2.ch ) || x0.gstexemptcode 
    ) || x2.ch ) || x0.gstratecode ) || x2.ch ) ,((((((((((((((((((((((((((((((x0.cooindicator 
    ...
    || x2.ch ) || x0.specialinstruct ) from "informix".tariff 
    x0 ,"informix".ctry_code x1 ,"ipgown".delimiter x2 where (x1.ctrycode 
    = x0.placeexp ) ;           
...
create index "informix".securuser_rk2 on "informix".securuser 
    (username) using btree  in indxdbs1;
create unique index "informix".account_cont_rk1 on "informix".account_contact 
    (liiclientno,liiaccountno,employeeno) using btree  in indxdbs2;
    
create index "informix".account_cont_rk3 on "informix".account_contact 
    (liiaccountno) using btree  in indxdbs2;
...
create unique index "informix".privilege_rk1 on "informix".privilege 
    (securgroupiid desc,serviceiid desc) using btree  in indxdbs1;
...
create unique index "informix".securgroup_rk2 on "informix".securgroup 
    (groupname desc) using btree  in indxdbs1;
...
create unique index "informix".company_rk1 on "informix".company 
    (liiclientno,companyname) using btree  in indxdbs1;
...
create index "informix".tariff_rk3 on "informix".tariff (tariffcode) 
    using btree  in indxdbs1;
create index "informix".tariff_rk4 on "informix".tariff (hsno) 
    using btree  in indxdbs2;
create index "informix".tariff_rk5 on "informix".tariff (tarifftrtmnt) 
    using btree  in indxdbs1;
create unique index "informix".rpt_b3_rk1 on "informix".rpt_b3 
    (useriid,b3iid) using btree  in indxdbs2;
...
create index "informix".rpt_b3_line_rk3 on "informix".rpt_b3_line 
    (b3subiid) using btree  in indxdbs1;
...
create unique index "informix".insight_pdq_rk2 on "informix".insight_pdq 
    (query_type) using btree  in indxdbs1;
