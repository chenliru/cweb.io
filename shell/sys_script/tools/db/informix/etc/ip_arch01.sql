...
CREATE PROCEDURE "informix".cleanb3(startdate CHAR(20), enddate CHAR(20))
  ...
  FOREACH
     ...
     RESUME;
         ...
         DELETE FROM b3
             WHERE b3iid = s_b3iid and approveddate like '2008/11/%';
         END
  END FOREACH;
...
create view "ipgown".trk_srb3_4 (data,b3iid,liibrchno,liirefno) as 
  select ((((((((((((((((((((((((((((((((((((((((((((((((((((((((
    ...
    [1,1] ) || x0.reldate [1,10] ) || x5.ch [1,1] ) || "ipgown"
    .p_invbrchno(x0.liibrchno )) || "ipgown".p_invrefno(x0.liirefno 
    )) ,x0.b3iid ,x0.liibrchno ,x0.liirefno from "informix".b3 
    x0 ,"informix".canct_off x1 ,"informix".canct_off x2 ,"informix"
    .usport_exit x3 ,"informix".transp_mode x4 ,"ipgown".delimiter 
    x5 where ((((x0.usportexit = x3.portexit ) AND (x0.modetransp 
    = x4.transpmode ) ) AND (x0.custoff = x1.canctoffcode ) ) 
    AND (x0.portunlading = x2.canctoffcode ) ) ;             
