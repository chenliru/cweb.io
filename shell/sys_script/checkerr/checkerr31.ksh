...
cd ${LogDir}
loglist $infileDir/ierr031.$rundate > ${rundate}031.xls
cut -c 9-63,71-83,96-158,192-194 ${rundate}031.xls > ${rundate}031.out

out31=$rundate"031.out"
/usr/bin/rcp ${LogDir}/$out31 "informix@bellat:$out31"
