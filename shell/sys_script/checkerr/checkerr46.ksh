...
cd ${LogDir}
loglist $infileDir/ierr046.$rundate > ${rundate}046.xls
cut -c 9-63,71-83,96-158,192-194 ${rundate}046.xls > ${rundate}046.out

out46=$rundate"046.out"
/usr/bin/rcp ${LogDir}/$out46 "informix@bellat:$out46"
