...
cd ${LogDir}
loglist $infileDir/ierr032.$rundate > ${rundate}032.xls
cut -c 9-63,71-83,96-158,192-194 ${rundate}032.xls > ${rundate}032.out

out32=$rundate"032.out"
/usr/bin/rcp ${LogDir}/$out32 "informix@bellat:$out32"
