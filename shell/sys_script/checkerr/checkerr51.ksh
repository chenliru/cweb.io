...
cd ${LogDir}
loglist $infileDir/ierr051.$rundate > ${rundate}051.xls
cut -c 9-63,71-83,96-158,192-194 ${rundate}051.xls > ${rundate}051.out

out51=$rundate"051.out"
/usr/bin/rcp ${LogDir}/$out51 "informix@bellat:$out51"
