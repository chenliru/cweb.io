#!/bin/ksh93
###########################################################################
#  Manual run AWS process for exist key files
#
#  1. put key files under /home/lchen/aws/in
#  2. run /home/lchen/aws/manaws.sh
#  3. find output under /home/lchen/aws/out
#
#  Author : Liru Chen
#  Date: 2015-09-22
###########################################################################
...
[[ ! -d ${AWSINDIR}/keydone ]] && mkdir -p ${AWSINDIR}/keydone
[[ ! -d ${AWSTMPDIR} ]] && mkdir -p ${AWSTMPDIR}
[[ ! -d ${AWSOUTDIR} ]] && mkdir -p ${AWSOUTDIR}

export BASE BIN TMP ETC LOG AWSINDIR AWSTMPDIR AWSOUTDIR
