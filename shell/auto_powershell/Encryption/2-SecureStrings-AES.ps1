...
$encryptedSecureString | Out-File -FilePath c:\2-SecureStrings-AES.SecureString.txt
$encryptedSecureKey | Out-File -FilePath c:\2-SecureStrings-AES.Key.txt
...
$encryptedSecureKey = Get-Content c:\2-SecureStrings-AES.Key.txt
$encryptedSecureString = Get-Content c:\2-SecureStrings-AES.SecureString.txt
