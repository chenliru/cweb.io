$day_offset=(get-date).DayOfWeek.value__

$weekdate1 = (get-date).AddDays(-($day_offset+6)).ToString('yyyyMMdd')
$weekdate2 = (get-date).AddDays(-($day_offset+2)).ToString('yyyyMMdd')
...
$paramHash = @{
 ...
 #To = "Chen, Liru <LChen@livingstonintl.com>"
