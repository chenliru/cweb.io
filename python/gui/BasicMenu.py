...
class PhotoEditor(QMainWindow):
    ...
    def photoEditorWidgets(self):
        ...
        # Use setSizePolicy to specify how the widget can be resized, horizontally and vertically.
        # Here, the image will stretch; horizontally, but not vertically.
    ...
    def rotateImage180(self):
        ...
        if not self.image.isNull():
            ...
            self.image_label.setPixmap(
                rotated.scaled(self.image_label.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation))
    ...
    def flipImageHorizontal(self):
        ...
        if not self.image.isNull():
            ...
            self.image_label.setPixmap(
                flipped.scaled(self.image_label.size(), Qt.KeepAspectRatio, Qt.SmoothTransformation))
